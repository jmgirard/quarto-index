...
it, then to your `lang:`, then to the English word or the ASCII mark. A whole
`index-labels:` map written inside an `indexes:` entry that is itself refused
as a declaration sets no word either, and that is reported beside the reason
