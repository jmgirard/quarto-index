...
alone, these words follow your document's `lang:`: Spanish, French, German and
Italian are covered, German for `see` and `see also` but not for this heading,
and every other language keeps the English words. So a `lang: es` document
heads this group `Símbolos` with nothing written under `index-labels:` at all.
