...
and the next, and the mark between two cross-references. Set any of the five
...
punctuation from `makeindex` and from the `\see` and `\seealso` commands,
which neither separator key touches.
