...
`#refs` div and the placement marker below it — see [Placing the
index](placing-the-index.qmd). A document with no marks gets none of this, except six one-line
...
described on [The principal mention of a
term](principal-mention.qmd).
