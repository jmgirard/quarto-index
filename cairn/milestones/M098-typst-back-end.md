...
- 2026-09-13: T6 done. Run 34785351085 (https://github.com/jmgirard/quarto-index/actions/runs/34785351085) at ddc13a7 passed: both Typst steps passed on the floor (1.5.52), pinned (1.10.18) and release legs. `tests/pdfindex.py` is unchanged: it reads the Typst index's order, levels and footer as they stand. The reader takes links from the PDF's link annotations, because `pdftohtml -xml` at its default zoom assigned a link to the wrong characters.
