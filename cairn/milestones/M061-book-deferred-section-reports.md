...
- [ ] T2. The record carries `adopted` (index names this chapter took on) and `unseen` (the
      ...
      chapter's terms.
- [ ] T3. The deferred-section report reads the recorded adoption and names the unseen
...
- [ ] T4. The doubled-section report, drawn by the book's last chapter from the records.
