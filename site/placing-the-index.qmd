...
- **An index no marker names, in an HTML book**, goes at the end of the book's
  last chapter, on every render, provided some chapter of the book places an
  index. Where that chapter carries a marker of its own the section follows
  the ones its markers place. The [Books](books.qmd) page has the whole of it.
