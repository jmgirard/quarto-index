...
- `marks_emitted` is module-level state, latent if Lua state is ever reused across documents; the HTML back-end adds two more such accumulators — added 2026-08-16, widened by M03 review P1 — M01 review R16
