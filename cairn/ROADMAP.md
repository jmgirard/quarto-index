...
|---|---|---|---|---|---|
| M39 | The sort-key rival and dangling-target reports name the index they judge | planned | — | normal | milestones/M39-report-index-scope.md |
