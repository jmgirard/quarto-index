...
- [ ] T1. Add a suite helper beside `m061_block_record`
...
- [ ] T2. Rewrite the probe at `_extensions/index/modules/book.lua:179`: list
...
- [ ] T3. Suite checks for AC1, AC2 and AC4 over the new fixture: the href-form
...
- [ ] T4. Hold the cold control (AC3) against the widened probe, and add a
...
- [ ] T5. `--self-test` plants, one per axis the probe is free in: the
...
- [ ] T6. The decision entry extending D-043; `site/books.qmd` and
