...
_Last hygiene check: 2026-09-14 (M098 archived, M095 row pruned. No lesson added, LESSONS at its byte budget. Validate green.)_
...
|---|---|---|---|---|---|
| M099 | A Typst locator prints the number its page shows | in-progress | — | normal | milestones/M099-typst-locator-numbering.md |
