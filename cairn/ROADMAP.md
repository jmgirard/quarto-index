...
- The emptied-container report covers divs, block quotes, figures, footnotes and list items, but a table cell emptied by a nested marker is still stripped unreported; README states the rule without naming the covered kinds — added 2026-08-18 — M08 review F3, partial fix
